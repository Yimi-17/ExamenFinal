...
public class AsignaturaPanel extends javax.swing.JPanel {
    ...
    private void paintForm() {
        if (table.getSelectedRow() != -1) {
            ...
            nombre.setText(d.getAsignatura());
    ...
    private void initComponents() {
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
                .addComponent(msgPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 419, Short.MAX_VALUE)
                .addGap(62, 62, 62))
    ...
    private void guardarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarButtonActionPerformed
        ...
        if (nombre.getText().trim().isEmpty()) {
            nombre.requestFocus();
            nombre.setBorder(new LineBorder(new java.awt.Color(255, 0, 0), 3));
            MsgPanel.msg("Asignatura es requerido", true);
        } else {
            Asignatura s = new Asignatura();
            s.setAsignatura(nombre.getText());
    ...
    private void nombreKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nombreKeyReleased
        // TODO add your handling code here:
        if (!nombre.getText().trim().isEmpty()) { //reset
            nombre.setBorder(new LineBorder(new java.awt.Color(0, 0, 0), 1));
            MsgPanel.msg("");
        } else {
            nombre.setBorder(new LineBorder(new java.awt.Color(255, 0, 0), 3));
