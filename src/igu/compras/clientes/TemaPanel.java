...
public class TemaPanel extends javax.swing.JPanel {
    ...
    TemaTableModel prodTableModel = new TemaTableModel();
    ...
    private void paintTable(TemaTableModel tableModel) {
    ...
    private void paintForm() {
        if (table.getSelectedRow() != -1) {
            Tema filax = (Tema) prodTableModel.getRow(table.getSelectedRow());
            Tema d = TemaData.getByPId(filax.getId());
            comboasig.getSelectedItem().toString();
            detalles.setText(d.getDetalles());
           
            fecha_vencimiento.setDate(d.getFecha_inicio());
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        .addGap(8, 8, 8)
                        .addComponent(fecha_inicio, javax.swing.GroupLayout.PREFERRED_SIZE, 285, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel8Layout.createSequentialGroup()
    ...
    private void guardarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarButtonActionPerformed
        // TODO add your handling code here:
            ...
            s.setFecha_inicio(fecha_inicio.getDate());
            ...
            if (table.getSelectedRow() != -1) {// ha seleccionado, update
                try {
                    Tema fila = (Tema) prodTableModel.getRow(table.getSelectedRow());
                    s.setId(fila.getId());
                    System.out.println("id:" + s.getId());
                    if (s.getId() > 0) {
                        int returnId = TemaData.update(s);
                        if (returnId != 0) {
                            paintTable(new TemaTableModel());
                            resetForm();
                ...
                try {
                    int returnId = TemaData.create(s);
                    if (returnId != 0) {
                        paintTable(new TemaTableModel());
        ...
        if (table.getSelectedRow() != -1) {
            try {
                ...
                if (opc == JOptionPane.OK_OPTION) {
                    ...
                    int opcion = TemaData.delete(fila.getId());
                    if (opcion != 0) {
    ...
    private void buscarFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarFieldKeyReleased
        // TODO add your handling code here:
        TemaTableModel tableModel = new TemaTableModel(buscarField.getText());
    ...
    private void theButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_theButton4ActionPerformed
        ...
        try {
            ...
            ErrorLogger.log(Level.SEVERE, TemaPanel.class.getName() + ".ExportarExcel", ex);
            //Logger.getLogger(TemasPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
